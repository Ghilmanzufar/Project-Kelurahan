{{-- Modal ini akan membaca state Alpine.js (showConfirmModal, confirmMessage, dll.) dari parent-nya --}}
<div x-show="showConfirmModal" class="fixed z-[60] inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" style="display: none;">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        {{-- Latar belakang overlay (klik ini akan menutup modal konfirmasi) --}}
        ...
        <div x-show="showConfirmModal" x-transition:enter="ease-out duration-300" 
            ...
            <div class="bg-red-600 px-4 py-3 sm:px-6 flex justify-between items-center">
                ...
                <button type="button" @click="showConfirmModal = false" class="text-white hover:text-red-200 focus:outline-none">
