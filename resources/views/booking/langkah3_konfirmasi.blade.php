                ...
                <div class="lg:flex lg:gap-x-12">
                    ...
                    <div class="lg:w-2/3">
                        <div class="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200">
                            ...
                            {{-- =============================================== --}}
                            {{-- <<< TAMBAHAN: DAFTAR DOKUMEN WAJIB >>> --}}
                            {{-- =============================================== --}}
                            @if($layanan->dokumenWajib->isNotEmpty())
                                <div class="mt-8 bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-md shadow-sm">
                                    <div class="flex">
                                        <div class="flex-shrink-0">
                                            {{-- Ikon Info Biru --}}
                                            ...
                                            <div class="mt-2 text-sm text-blue-700">
                                                <ul class="list-disc pl-5 space-y-1">
                                                    ...
                                                    @foreach($layanan->dokumenWajib as $dokumen)
                                                        <li>{{ $dokumen->deskripsi_dokumen }}</li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                            <p class="mt-2 text-xs text-blue-600 italic">
                                                *Mohon bawa dokumen Asli & Fotokopi untuk verifikasi.
                                            </p>
                                        </div>
                                    </div>
                                </div>
